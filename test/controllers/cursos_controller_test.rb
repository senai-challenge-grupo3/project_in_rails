...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { alunos: @curso.alunos, nome: @curso.nome, observacao: @curso.observacao, professor: @curso.professor } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { alunos: @curso.alunos, nome: @curso.nome, observacao: @curso.observacao, professor: @curso.professor } }
